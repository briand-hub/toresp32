...
namespace Briand {
	...
	const char* BriandTorCertificateBase::LOGTAG = "briandcert";
	const char* BriandTorEd25519CertificateExtension::LOGTAG = "briandcert";
	const char* BriandTorEd25519CertificateBase::LOGTAG = "briandcert";
	const char* BriandTorCertificate_RSAEd25519CrossCertificate::LOGTAG = "briandcert";
