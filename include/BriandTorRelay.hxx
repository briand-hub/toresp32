...
namespace Briand {
	...
	*/
	class BriandTorRelay {
		...
		/** Context with client private/public keys generated by ECDH (mbedtls library dependent) WARNING: will be used and then released so never use without check if nullptr! */
